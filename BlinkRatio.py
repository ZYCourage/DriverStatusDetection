...
import math
import numpy as np
import utils_blink_ratio.utils as utils
...
def frameCounter(media):
    global TOTAL_BLINKS, CEF_COUNTER, frame_counter
    ratiolist = [4, 4, 4, 4, 4]
    with map_face_mesh.FaceMesh(min_detection_confidence=0.5, min_tracking_confidence=0.5) as face_mesh:
        ...
        while True:
            ...
            if results.multi_face_landmarks:
                ...
                utils.colorBackgroundText(frame, f'Ratio : {round(ratio, 2)}', FONTS, 0.7, (30, 100), 2, utils.WHITE,
                                          utils.PINK)
                ave = mean(ratiolist)
