...
from utils_blink_ratio import utils as utils_blink_ratio
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # Show module shadows
        UIFuncitons.shadow_style(self, self.Class_QF, QColor(251, 157, 139))
        UIFuncitons.shadow_style(self, self.Target_QF, QColor(251, 157, 139))
        UIFuncitons.shadow_style(self, self.Fps_QF, QColor(251, 157, 139))
        ...
        try:
            ...
            with BlinkRatio.map_face_mesh.FaceMesh(min_detection_confidence=0.5, min_tracking_confidence=0.5) as face_mesh:
                ...
                if results.multi_face_landmarks:
                    ...
                    utils_blink_ratio.colorBackgroundText(frame, f'Ratio : {round(ratio, 2)}', BlinkRatio.FONTS, 0.7, (30, 100), 2, utils_blink_ratio.WHITE,
                                              utils_blink_ratio.PINK)
                    ave = mean(ratiolist)
                    if ratio > ave + THRESHOLD:
                        CEF_COUNTER += 1
                        utils_blink_ratio.colorBackgroundText(frame, f'Blink', BlinkRatio.FONTS, 1.7, (50, 100), 2, utils_blink_ratio.WHITE, utils_blink_ratio.YELLOW)
                    else:
