...
"	background-color: qlineargradient(x0:0, y0:1, x1:1, y1:1,stop:0.4  rgb(0, 0, 0), stop:1 rgb(28,9, 43));\n"
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Author.setText(QCoreApplication.translate("MainWindow", u"Detection", None))
        self.Title.setText(QCoreApplication.translate("MainWindow", u"DriverStatus", None))
        ...
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"司机驾驶状态监测  \u2013  基于深度学习的司机驾驶状态监测系统", None))
        self.settings_button.setText("")
        self.min_sf.setText("")
        self.max_sf.setText("")
        self.close_button.setText("")
        self.char_label.setText(QCoreApplication.translate("MainWindow", u"Detection", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"眨眼次数", None))
        self.Class_num.setText("")
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"疲劳程度", None))
        self.Target_num.setText("")
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"采样帧数", None))
